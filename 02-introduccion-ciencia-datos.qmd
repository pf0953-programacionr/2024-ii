...
# Introducción a la ciencia de datos {.unnumbered}
...
Çetinkaya-Rundel, Mine, & Hardin, Johanna (2021). *Chapter 1: Hello data* en *Introduction to Modern Statistics* (1st ed.). OpenIntro, Inc. [https://openintro-ims.netlify.app/data-hello](https://openintro-ims.netlify.app/data-hello)
...
Wickham, Hadley; Çetinkaya-Rundel, Mirne; & Grolemund, Garret (2023). *Introduction* en *R for Data Science: Import, Tidy, Transform, Visualize, and Model Data* (2nd ed.). O’Reilly Media. [https://r4ds.hadley.nz/intro](https://r4ds.hadley.nz/intro)
...
Las variables de los datos de la tabla 1 son de varios tipos, cuya jerarquía se muestra en la @fig-tipos-variables-estadisticas.

![Tipos de variables estadísticas. Imagen de @cetinkaya-rundel_introduction_2021](img/tipos-variables-estadisticas.png){#fig-tipos-variables-estadisticas .lightbox fig-alt="Imagen de tipos de variables estadíticas" fig-align="center"}
...
La ciencia de datos es una disciplina que permite convertir datos "crudos" (sin procesar) en comprensión y conocimiento @wickham_r_2023. Se basa en la estadística y en las ciencias de la computación, entre otras disciplinas.

### Procesos

La @fig-modelo-ciencia-datos ilustra el ciclo de vida de un proyecto típico de ciencia de datos, el cual incluye los procesos de importar, ordenar, transformar, visualizar, modelar y comunicar. Todos se articulan mediante programación de computadoras.

![Ciclo de vida de un proyecto de ciencia de datos. Imagen de @wickham_r_2023](img/modelo-ciencia-datos.svg){#fig-modelo-ciencia-datos .lightbox fig-alt="Imagen del ciclo de vida de un proyecto de ciencia de datos" fig-align="center"}
...
La @fig-problemas-regresion-clasificacion ilustra varios problemas resueltos mediante [regresión](https://es.wikipedia.org/wiki/An%C3%A1lisis_de_la_regresi%C3%B3n) y [clasificación](https://es.wikipedia.org/wiki/Clasificaci%C3%B3n_estad%C3%ADstica), dos técnicas que se utilizan en *deep learning*. En cada caso, hay una entrada que puede tener diversos formatos como un conjunto de números, una hilera de texto, un archivo de sonido o una imagen. Esta entrada se transforma y se codifica como un vector de números. Este vector constituye la entrada del modelo de regresión o clasificación. El modelo convierte la entrada en un vector de salida que se "traduce" de nuevo a un formato adecuado.

![Problemas de regresión y clasificación. Imagen de @prince2023understanding](img/problemas-regresion-clasificacion.png){#fig-problemas-regresion-clasificacion .lightbox fig-alt="Imagen de problemas de regresión y clasificación" fig-align="center"}
...
En la @fig-problemas-regresion-clasificacion, los modelos de *deep learning* se muestran como "cajas negras" que reciben una entrada y retornan una salida, sin entrar en detalles de como se procesa la entrada. Hay muchas posibilidades para implementar estas "cajas negras". Considere un modelo para predecir la estatura de un niño a partir de su edad, como el de la @fig-modelo-aprendizaje-automatico. En este caso, el modelo es una ecuación que describe como la estatura promedio varía en función de la edad. Al ingresar la edad a la ecuación, retorna la estatura.

![Modelo de aprendizaje automático. Imagen de @prince2023understanding.](img/modelo-aprendizaje-automatico.png){#fig-modelo-aprendizaje-automatico .lightbox fig-alt="Imagen de modelo de aprendizaje automático" fig-align="center"}
...
![Espectro de reproducibilidad. Imagen de [Anita Graser](https://www.youtube.com/watch?v=ZjXb53pOor0) basada en @peng_reproducible_2011.](img/espectro-reproducibilidad.png){#fig-espectro-reproducibilidad .lightbox fig-alt="Imagen del espectro de reproducibilidad" fig-align="center"}
